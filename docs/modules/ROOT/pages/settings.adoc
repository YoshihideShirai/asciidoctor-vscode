...
|Built-in stylesheet used when `asciidoc.preview.style` is empty and the document does not set `stylesheet`/`stylesdir`. Possible values: `vscode`, `asciidoctor`, `antora`, `github-light`, `github-dark`.
|`vscode`
